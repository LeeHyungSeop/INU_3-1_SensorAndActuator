...
% 상단 경계
upper_line_x = [0, 6-r, 6, 6, 16.7];
upper_line_y = [4.7, 4.7, 4.7+r, 19.7, 19.7] - 1*ones(1,5);
% 하단 경계
lower_line_x = [0, 10.7, 10.7, 10.7+r, 16.7];
lower_line_y = [0, 0, 15-r, 15, 15]- 1*ones(1,5);
% 모퉁이 그릴 곳에 라인이 그려지니까 지우기 위해
erase1_x = [6-r, 6];
erase1_y = [4.7, 4.7+r] - 1*ones(1,2);
erase2_x = [10.7, 10.7+r];
erase2_y = [15-r, 15] - 1*ones(1,2);
